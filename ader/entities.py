"""
Data structures for ADER.

This module defines entity, relation, token, document, and dataset containers
used by the ADER model. The implementation follows a span-based joint
entity-relation extraction framework and has been adapted for ADER.
"""
