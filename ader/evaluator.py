"""
Evaluation utilities for ADER.

This module computes strict entity and relation extraction metrics, including
relation evaluation with and without named entity classification.
"""
import os
import warnings
...
from ader.entities import Document, Dataset, EntityType
from ader.input_reader import BaseInputReader
from ader.opt import jinja2
