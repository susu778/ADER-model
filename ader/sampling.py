"""
Sampling utilities for ADER.

This module creates training and evaluation samples for span-based entity
classification and multi-label relation extraction.
"""
import random
