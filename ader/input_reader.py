"""
Input readers for ADER.

This module loads entity and relation schemas, reads JSON-formatted datasets,
and converts token-level annotations into ADER document objects.
"""
import json
...
from ader.entities import Dataset, EntityType, RelationType, Entity, Relation, Document
from ader.opt import spacy
...
class BaseInputReader(ABC):
    def __init__(self, types_path: str, tokenizer: BertTokenizer, neg_entity_count: int = None,
        ...
        with open(types_path, encoding='utf-8') as f:
            types = json.load(f, object_pairs_hook=OrderedDict)  # entity + relation types
